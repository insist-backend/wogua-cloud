...
public class WoguaUserInfoTokenServices implements ResourceServerTokenServices {
    ...
    public WoguaUserInfoTokenServices(String userInfoEndpointUrl, String clientId) {
